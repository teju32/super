...
function setup() {
  ...
  box1 = new Box(560, 100, 70, 70);
  box2 = new Box(560, 100, 70, 70);
  box3 = new Box(560, 100, 70, 70);
  box4 = new Box(560, 100, 70, 70);
  box5 = new Box(560, 100, 70, 70);
  ...
  box21 = new Box(680, 100, 70, 70);
  box22 = new Box(680, 100, 70, 70);
  box23 = new Box(680, 100, 70, 70);
  box24 = new Box(600, 100, 70, 70);
  box25 = new Box(680, 100, 70, 70);
  box26 = new Box(680, 100, 70, 70);
